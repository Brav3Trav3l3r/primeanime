<footer class="w-full bg-base-300 body-font mt-10">
	<div
	...
	>
		<div class="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
			<a href="#"
				class="flex items-center justify-center font-medium title-font md:justify-start"
			>
				<svg
					class="w-auto h-5 opacity-50 fill-current"
					viewBox="0 0 202 69"
		...
		<div class="flex flex-wrap flex-grow text-center lg:-mb-10 md:mt-0">
			<div class="w-full px-4 mt-4 lg:w-1/4 md:w-1/4">
				<a href="#" class=" cursor-pointer hover:opacity-80 opacity-30">Send a Message</a>
			</div>
			<div class="w-full px-4 mt-4 lg:w-1/4 md:w-1/4">
				<a href="#" class=" cursor-pointer hover:opacity-80 opacity-30">Terms & Privacy</a>
			</div>
			<div class="w-full px-4 mt-4 lg:w-1/4 md:w-1/4">
				<a href="#" class=" cursor-pointer hover:opacity-80 opacity-30">DMCA policy</a>
			</div>
			<div class="w-full px-4 lg:w-1/4 md:w-1/4 lg:text-right">
				<div class="mt-4">
					<span class="inline-flex justify-center mt-2 sm:ml-auto sm:mt-0 sm:justify-start">
						<a href="#" class=" cursor-pointer opacity-30 hover:opacity-70">
							<svg
								fill="currentColor"
						...
						<a href="#" class="ml-3  cursor-pointer opacity-30 hover:opacity-70">
							<svg
								fill="currentColor"
								stroke-linecap="round"
								stroke-linejoin="round"
